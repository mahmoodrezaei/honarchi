...
export default {
  ...
  methods: {
    ...
    attributeItemTypeChenge() {
      switch (this.attributeItem.type) {
        case "text":
          ...
          this.showAttributeRequest().then(data => {
            if (data.configuration.type == "text")
              this.configuration = data.configuration;
            else this.attributeItem.configuration = {};
          });
          break;
        case "select":
          ...
          this.showAttributeRequest().then(data => {
            if (data.type == "select")
              this.attributeItem.configuration = data.configuration;
            else
    ...
    showAttributeRequest() {
      return axios
        .get(attributesRoutes.show.url + this.$route.params.id)
        .then(response => {
