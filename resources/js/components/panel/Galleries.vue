              ...
              >
                <tbody class="m-datatable__body">
                  ...
                  >
                    ...
                    <td class="m-datatable__cell">
                      <div style="width: 110px;">{{ gallery.location }}</div>
                    </td>
                    <td class="m-datatable__cell">
                      <div style="width: 110px;">
                        <span
                          v-if="gallery.state === 'بلاک' "
                          class="m-badge m-badge--danger m-badge--wide"
                        >{{ gallery.state }}</span>
                        <span
                          v-else-if="gallery.state === 'تایید نشده' "
                          class="m-badge m-badge--warning m-badge--wide"
                        >{{ gallery.state }}</span>
                        <span
                          v-else-if="gallery.state === 'تایید شده' "
...
export default {
  ...
  methods: {
    ...
    approve(gallery) {
      ...
      axios
        .patch("api/admin/galleries/" + gallery.id + "/approve")
        .then(response => {
