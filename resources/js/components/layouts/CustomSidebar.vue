    ...
    <div id="m_aside_left" class="m-grid__item m-aside-left m-aside-left--skin-dark">
      ...
      >
        <ul class="m-menu__nav m-menu__nav--dropdown-submenu-arrow">
          ...
          <li class="m-menu__item m-menu__item--submenu" aria-haspopup="true">
            <a href="#" @click.prevent="$router.push('/admin/attributes')" class="m-menu__link">
              <i class="m-menu__link-icon flaticon-line-graph"></i>
              <span class="m-menu__link-title">
                <span class="m-menu__link-wrap">
          ...
          <li class="m-menu__item m-menu__item--submenu" aria-haspopup="true">
            <a href="#" @click.prevent="$router.push('/admin/permissions')" class="m-menu__link">
              <i class="m-menu__link-icon flaticon-user-settings"></i>
              <span class="m-menu__link-title">
                <span class="m-menu__link-wrap">
                  <span class="m-menu__link-text">اجازه دسترسی‌ها</span>
                </span>
              </span>
            </a>
          </li>
          ...
          <li class="m-menu__item m-menu__item--submenu" aria-haspopup="true">
            <a href="#" @click.prevent="$router.push('/admin/file_manager')" class="m-menu__link">
              <i class="m-menu__link-icon flaticon-user-settings"></i>
              <span class="m-menu__link-title">
                <span class="m-menu__link-wrap">
                  <span class="m-menu__link-text">مدیریت فایل ها</span>
                </span>
              </span>
            </a>
          </li>
